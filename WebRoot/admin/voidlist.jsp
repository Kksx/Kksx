                            ...
                            <div id="dataTables-example_filter" class="dataTables_filter" style="padding-top:30px;">
                                <label>
                                    <input type="text" name="teachername" value="${teachername }"
                                           class="form-control input-sm" placeholder="请输入老师名"
                                           aria-controls="dataTables-example">
                                    <input type="text" name="voidname" value="${voidname }"
                                           class="form-control input-sm" placeholder="请输入视频名"
                                           aria-controls="dataTables-example">
            ...
            <form action="<%=Const.ROOT%>void/getVoidlist" method="post" id="Page">
                    ...
                    <div class="dataTables_paginate paging_simple_numbers" id="dataTables-example_paginate">
                        <ul class="pagination">
                            <li class="paginate_button previous" aria-controls="dataTables-example" tabindex="0"
                                id="dataTables-example_previous"><a href="javascript:doPage('${pageInfo.prePage}')"
                                                                    aria-label="Previous">
                                <span aria-hidden="true">&laquo;</span>
                            </a></li>

                            <li class="paginate_button next" aria-controls="dataTables-example" tabindex="0"
                                id="dataTables-example_next"><a href="javascript:doPage('${pageInfo.nextPage}')"
                                                                aria-label="Next">
                ...
                <div class="col-sm-6">
                    <div id="dataTables-example_filter" class="dataTables_filter">
                        <label>跳转到<input type="number" id="pageNum" name="pageNum" class="form-control input-sm"
                                         aria-controls="dataTables-example">
