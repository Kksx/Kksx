                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <c:if test="${item!=null}">
                                <form class="col s12" action="<%=Const.ROOT%>user/updateMe" method="post"
                                      enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="input-field col s6">
                                            <i class="material-icons prefix">account_circle</i>
                                            <input id="username" name="username" value="${item.username }" required=""
                                                   type="text" class="validate">
                                            <label for="icon_prefix">用户名</label>
                                        </div>
                                        <div class="input-field col s6">
                                            <i class="material-icons prefix">phone</i>
                                            <input id="phone" name="phone" type="number" value="${item.phone }"
                                                   required="" class="validate">
                                            <label for="icon_telephone">phone</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="input-field col s6">
                                            ...
                                            <input id="realname" name="realname" type="text" value="${item.realname }"
                                                   required="" class="validate">
                                            <label for="icon_prefix">真实姓名</label>
                                        </div>
                                        <div class="input-field col s6">

                                            <input id="password" name="password" type="text" value="${item.password }"
                                                   required="" class="validate">
                                            <label for="icon_telephone">密码</label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input id="address" name="address" type="text" value="${item.address }"
                                                   required="" class="validate">
                                            <label for="address" data-error="wrong" data-success="right">地址</label>
                                        </div>
                                    </div>
