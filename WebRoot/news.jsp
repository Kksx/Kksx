    ...
    <div id="page-wrapper" style="margin-top: -20px">
        ...
        <div id="page-inner">
            ...
            <div class="row">
                ...
                <div class="modal fade" id="hufuModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="row" id="hufumodal" style="display: none">
                            <div class="col-lg-12">
                                <div class="card-content">
                                    <form class="col s12" action="<%=Const.ROOT%>news/addhufu" method="post"
                ...
                <div class="modal fade" id="myRecordModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
                     aria-hidden="true">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                        ...
                        <div class="row" id="addRecordmodal" style="display: none">
                            <div class="col-lg-12">
                                <div class="card-content">
                                    <form class="col s12" action="<%=Const.ROOT%>news/addRecordthr" method="post"
                                          enctype="multipart/form-data">
