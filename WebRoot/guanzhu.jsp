                                ...
                                <tr class="info">
                                    ...
                                    <td>
                                        <a class="waves-effect waves-light btn"
                                           href="<%=Const.ROOT%>void/getMyGuanZhu?id=${item.nid}">
                                            查看</a>
                                        <a class="waves-effect waves-light btn" data-toggle="modal"
                                           data-target="#sixinModal" onclick="hufu(${item.nid })">
                                            私信</a>
                                        <a class="waves-effect waves-light btn" data-toggle="modal"
...
<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-content">
        ...
        <div class="row" id="deletemodal" style="display: none">
            <div class="col-lg-12">
                <div class="card-content">
                    <form class="col s12" action="<%=Const.ROOT%>user/delGuanZhu" method="post"
...
<div class="modal fade" id="sixinModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-content">
        ...
        <div class="row" id="sixinmodal" style="display: none">
            <div class="col-lg-12">
                <div class="card-content">
                    <form class="col s12" action="<%=Const.ROOT%>user/sixin" method="post"
                          enctype="multipart/form-data">
