                    ...
                    <c:forEach items="${tlist}" var="item" varStatus="count">
                        <div class="card">
                            ...
                            <div class="card-content" style="padding-top:10px;">
                                <p>
                                    <input name="group${count.index}" type="radio" value="A"
                                           style="position:static;opacity:1"> A.${item.opa }
                                </p>
                                <p>
                                    <input name="group${count.index}" type="radio" value="B"
                                           style="position:static;opacity:1"> B.${item.opb }
                                </p>
                                <p>
                                    <input name="group${count.index}" type="radio" value="C"
                                           style="position:static;opacity:1"> C.${item.opc }
                                </p>
                                <p>
                                    <input name="group${count.index}" type="radio" value="D"
                                           style="position:static;opacity:1">D.${item.opd }
                                </p>
                                <p>
                                    正确答案：${item.answer }
                                </p>
